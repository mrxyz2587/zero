...
class FinanceClubChatScreen extends StatefulWidget {
  String usernamecurrent;
  FinanceClubChatScreen({Key? key, required this.usernamecurrent})
      : super(key: key);

  @override
  State<FinanceClubChatScreen> createState() => _FinanceClubChatScreenState();
}

class _FinanceClubChatScreenState extends State<FinanceClubChatScreen>
  ...
  Future uploadImage() async {
    ...
    await _firestore.collection('financeclubchat').doc(fileName).set({
      "sendby": _auth.currentUser!.uid,
      "message": "",
      "type": "img",
      "time": FieldValue.serverTimestamp(),
          ...
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => GroupPostingScreen(
                      collectionname: 'financeclubchat',
