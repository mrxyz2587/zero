...
class _GlobalGroupChatScreenState extends State<GlobalGroupChatScreen>
  ...
  Future uploadImage() async {
    ...
    // await _firestore.collection('groupglobalchat').doc(fileName).set({
    //   "sendby": _auth.currentUser!.uid,
    //   "message": "",
    //   "type": "img",
    //   "time": FieldValue.serverTimestamp(),
    //   "sendername": usernamecurrent
    // });
          ...
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => GroupPostingScreen(
                      collectionname: 'groupglobalchat',
                      clubName: 'Confession Club',
