...
class CreativeClubChatScreen extends StatefulWidget {
  String usernamecurrent;
  CreativeClubChatScreen({Key? key, required this.usernamecurrent})
      : super(key: key);

  @override
  State<CreativeClubChatScreen> createState() => _CreativeClubChatScreenState();
}

class _CreativeClubChatScreenState extends State<CreativeClubChatScreen> {
  ...
  Future uploadImage() async {
    ...
    await _firestore.collection('creativeclubchat').doc(fileName).set({
      "sendby": _auth.currentUser!.uid,
      "message": "",
      "type": "img",
      "time": FieldValue.serverTimestamp(),
    ...
    var ref = FirebaseStorage.instance
        .ref()
        .child('imagescreative')
        .child("$fileName.jpg");

    var uploadTask = await ref.putFile(imageFile!).catchError((error) async {
      await _firestore.collection('creativeclubchat').doc(fileName).delete();
