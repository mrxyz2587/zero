...
class StartupClubChatScreen extends StatefulWidget {
  String usernamecurrent;
  StartupClubChatScreen({Key? key, required this.usernamecurrent})
      : super(key: key);

  @override
  State<StartupClubChatScreen> createState() => _StartupClubChatScreenState();
}

class _StartupClubChatScreenState extends State<StartupClubChatScreen>
  ...
  Future uploadImage() async {
    ...
    await _firestore.collection('startupclubchat').doc(fileName).set({
      "sendby": _auth.currentUser!.uid,
      "message": "",
      "type": "img",
      "time": FieldValue.serverTimestamp(),
          ...
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => GroupPostingScreen(
                      collectionname: 'startupclubchat',
